...
public class DivisibleBy {
    ...
    public static void main(String[] args) {
        ...
        /*
        Write a program that can print the numbers between 1 ~ N that can be divisible
        by 3, 5, and 15.
        ...
        //int n = new Scanner(System.in).nextInt(); //for one time use

        if(number<0){
            System.err.println("Invalid Number");
            System.exit(0);  //terminates the system in case the users enters a negative number
        }
