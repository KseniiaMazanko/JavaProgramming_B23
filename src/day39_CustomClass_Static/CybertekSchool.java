...
public class CybertekSchool {
    ...
    public static void main(String[] args) {
        ...
        Student[][] groups = { group1, group2, group3};//2dimensional array
        ...
        System.out.println("Market group 1: " + firstMarketGroup.size());
        System.out.println("Market group 2: " + secondMarketGroup.size());
        System.out.println("Market group 3: " + thirdMarketGroup.size());

        System.out.println("___________________________________________");
        // who is the youngest student in the first market group
...
// who is the youngest avenger
        ...
        System.out.println("The youngest person's Date of Birth " + min);
        System.out.println("The youngest person's name " + name);

        // display the name of the students who were born between 1985-Jan-20 to 1995-Aug- 15

        for (Student[] eachGroup : groups) {
            for (Student eachStudent : eachGroup) {
                if(eachStudent.DoB.isAfter(LocalDate.of(1985, 1,20)) &&
                        eachStudent.DoB.isBefore(LocalDate.of(1995, 8,15))){
                    System.out.println(eachStudent.name + " : " + eachStudent.DoB);
                }
            }
